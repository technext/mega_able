                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h1 class="m-b-10">Gestion De Restaurante</h1>
                                      </div>
                                  </div>
                        ...
                        <div class="pcoded-inner-content">
                            ...
                            <div class="main-body">
                               <div class="card card-body">
                                    <form action="insertarestaurante.php" method="POST">
                                    <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <b><label class="control-label">Nit</label></b>
                                            <input type="text" class="form-control" name="Nit"
                                                placeholder="Digite el Nit" minlength="8" maxlength="10"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                           <b> <label class="control-label">Nombre De Restaurante</label></b>
                                            <input type="text" class="form-control" name="NombreRestaurante"
                                            placeholder="Digite Nombre de Restaurante" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" 
                                            required="required" minlength="3" maxlength="30" title="Solamente se admiten caracteres">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <b><label class="control-label">Nombre De Propietario</label></b>
                                            <input type="text" class="form-control" name="NombrePropietario"
                                            placeholder="Digite Nombre del Propietario" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" 
                                            required="required" minlength="3" maxlength="30" title="Solamente se admiten caracteres">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <b><label class="control-label">Dirección</label></b>
                                   ...
                                   <div class="col-lg-4">
                                        <div class="form-group">
                                            <b><label class="control-label">Cantidad De Empleados</label></b>
                                                <input type="text" class="form-control" name="CantidadEmpleados"
                                                placeholder="Digite Cantidad De Empleados" minlength="1" maxlength="10"
                                     ...
                                     <div class="col-lg-4">
                                        <div class="form-group">
                                            <b><label class="control-label">Variedad Gastronomica</label></b>
                                            <select class="form-control" name="VariedadGastronomica"  required="required">
                                                <option>Seleccione Variedad Gastronomica</option>
                                ...
                                <div class="modal-footer">
                                    <button type="submit" name="insertarestaurante" class="btn btn-success"><i
                  ...
                  <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result_tasks)) { ?>
                      <tr>
                        ...
                        <td><?php echo $row['CantidadEmpleados']; ?></td>
                        <td><?php echo $row['VariedadGastronomica']; ?></td>
                        ...
                        <td>
                          <a href="EditarRestaurante.php?Nit=<?php echo $row['Nit'] ?>" class="btn btn-secondary">
                            <i class="fas fa-marker"></i>
                          </a>
                          <a href="EliminarRestaurante.php?Nit=<?php echo $row['Nit'] ?>" class="btn btn-danger">
