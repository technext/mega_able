...
<head>
    <title>Informacion De Restaurante</title>
                              ...
                              <div class="main-menu-content">
                                  <ul>
                                      <li class="more-details">
                                          ...
                                          <a href="index"><i class="ti-layout-sidebar-left"></i>Salir</a>
                                      </li>
                                  </ul>
                              </div>
                          </div>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h1 class="m-b-10">Informacion De Restaurante</h1>
                                      </div>
                                  </div>
                      ...
                      <!-- Page-header end -->
                        <div class="pcoded-inner-content">
                          ...
                          <div class="card card-body">
                                       ...
                                       <form action="ModificarInformacionRestaurante.php" method="POST">
           
           <div class="col-lg-4">
                        <div class="form-group">
                            <label class="control-label">Nit</label>
                             <input name="Nit" type="text" class="form-control" placeholder="Digite Indentificacion" autofocus required="">
                        </div>
          </div>
          </div>
...
<div class="card card-body">
     ...
     <div class="row">  
              <div class="col-lg-4">
               <div class="form-group">
            <label class="control-label">¿el restaurante cuenta con las  instalaciones y equipo adecuado para personas con discapacidad(en sillas de ruedas)?"</label>
           <select class="form-control" name="Instalaciones"  required="required">
          ...
          <div class="col-lg-4">
          <div class="form-group">
            <label class="control-label">¿Realiza Descuentos o cupón especiales?</label>
           <select class="form-control" name="Cupo"  required="required">
                                                <option>Seleccione Respuesta</option>
                                                <option value="Si">Si</option>
                                                <option value="No">No</option>
                                            </select>
          ...
          <div class="col-lg-4">
            <div class="form-group">
            <label class="control-label">¿Que Cuentas Bancarias utiliza Para pagos atraves tranferencia?</label>
            <select class="form-control" name="Cuenta"  required="required">
                                                <option>Seleccione Respuesta</option>
      ...
      <div class="row">  
              ...
              <div class="col-lg-4">
               <div class="form-group">
                <label class="control-label">¿el restaurante cuenta con la señalizacion necesaria para casos de emergencia?</label>
                <select class="form-control" name="Seña"  required="required">
                                                <option>Seleccione Respuesta</option>
                                                <option value="Si">Si</option>
                                                <option value="No">No</option>
                                            </select>
         ...
         <div class="col-lg-4">
               <div class="form-group">
                <label class="control-label">¿Cuenta Con pagina web?</label>
                <select class="form-control" name="Pagina"  required="required">
                                                <option>Seleccione Respuesta</option>
                                                <option value="Si">Si</option>
                                                <option value="No">No</option>
                                            </select>
             ...
             <div class="col-lg-4">
               <div class="form-group">
                <label class="control-label">¿Cuenta el Restaurante con Conexion WI-Fi para los clientes?</label>
                 <select class="form-control" name="Afirmativo"  required="required">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>¿el restaurante cuenta con las  instalaciones y equipo adecuado para personas con discapacidad(en sillas de ruedas)?</th>
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result_tasks)) { ?>
                                            <tr>
                                                <td><?php echo $row['Instalaciones']; ?></td>
