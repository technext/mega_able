...
<head>
    <title>Cargar Examenes Medicos</title>
      ...
      <div class="pcoded-container navbar-wrapper">
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h1 class="m-b-10">Cargar Examanes Medicos</h1>
                                      </div>
                                  </div>
                        ...
                        <tbody>
                            <?php foreach ($res as $val) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <button onclick="openModelPDF('<?php echo $val['url'] ?>')" class="btn btn-outline-info">Vista Previa</button>
                                        <a class="btn btn-outline-dark" target="_black" href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/micro/' . $val['url']; ?>" >Pdf Pagina</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" id="form1">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="Identificacion">
                            </div>
                            <div class="form-group">
                                <label for="description">Nombres</label>
                                <input type="text" class="form-control" id="description" name="Nombres">
                            </div>
                            <div class="form-group">
                                <label for="description">Apellidos</label>
                                <input type="text" class="form-control" id="description" name="Apellidos">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-info" onclick="onSubmitForm()">Cuardar</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
                            ...
                            function openModelPDF(url) {
                                $('#modalPdf').modal('show');
                                $('#iframePDF').attr('src','<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/micro/'; ?>'+url);
                            }
        </script>
